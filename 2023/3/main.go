...
func part1(input string) {
	arena := strings.Split(input, "\n")

	world := world{
		arena: arena,
		w:     len(arena[0]),
		h:     len(arena),
		used:  make([]bool, len(arena)*len(arena[0])),
	}
	...
	for y := 0; y < world.h; y++ {
		for x := 0; x < world.w; x++ {
			...
			case isDigit(c):
			default:
				total += world.numberAt(x-1, y)
				total += world.numberAt(x+1, y)
				total += world.numberAt(x-1, y-1)
				total += world.numberAt(x, y-1)
				total += world.numberAt(x+1, y-1)
				total += world.numberAt(x-1, y+1)
				total += world.numberAt(x, y+1)
				total += world.numberAt(x+1, y+1)
...
func (w *world) numberAt(x, y int) int {
	if x >= w.w || y >= w.h || x < 0 || y < 0 {
		return 0
	}
	if !isDigit(w.arena[y][x]) {
		return 0
	}
	// Find the start
	for x > 0 {
		if !isDigit(w.arena[y][x-1]) {
			break
		}
		x--
	}
...
var input = `............830..743.......59..955.......663..........................................367...........895....899...............826...220......
.......284.....*............*.....$...+.....*...377..................*.......419.............488...*.......*...................*..-....939..
